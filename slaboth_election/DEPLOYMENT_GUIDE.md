# Sierra Leone Association of Business Owners in Tourism and Hospitality (SLABOTH) - Voting System Deployment Guide

## Welcome to Your Custom Voting System!

Your voting system has been configured for:
- **Organization**: Sierra Leone Association of Business Owners in Tourism and Hospitality (SLABOTH)
- **Election**: Executive Committee Elections
- **Positions**: 6 positions configured
- **Admin Token**: `slaboth-2024` (keep this secure!)
...
4. **Set Variables**: `heroku config:set ORGANIZATION_NAME="Sierra Leone Association of Business Owners in Tourism and Hospitality (SLABOTH)"` etc.
...
```bash
ORGANIZATION_NAME="Sierra Leone Association of Business Owners in Tourism and Hospitality (SLABOTH)"
ELECTION_TITLE="Executive Committee Elections"
ADMIN_TOKEN="slaboth-2024"
ELECTION_POSITIONS="Chairperson,Secretary,Treasurer,Public Relations & Communications Officer,Advocacy & Policy Officer,Admin Officer"
```
...
2. Enter admin token: `slaboth-2024`
...
Your custom voting system is ready to handle secure, anonymous elections for Sierra Leone Association of Business Owners in Tourism and Hospitality (SLABOTH). The system can handle hundreds to thousands of voters with real-time results and complete election transparency.
